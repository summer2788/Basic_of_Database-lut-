CREATE TABLE "Comments" (
	...
	FOREIGN KEY("UserlD") REFERENCES "User"("UserID")
    ON DELETE CASCADE,
	FOREIGN KEY("FK_CommentID") REFERENCES "Comments"("CommentID")
    ON DELETE CASCADE,
	FOREIGN KEY("TweetlD") REFERENCES "Tweet"("TweetlD")
    ON DELETE CASCADE
);
...
CREATE TABLE "HashtagsinContent" (
	...
	FOREIGN KEY("TweetlD") REFERENCES "Tweet"("TweetlD") ON DELETE CASCADE,
...
CREATE TABLE "Likes" (
	...
	FOREIGN KEY("CommentID") REFERENCES "Comments"("CommentID") ON DELETE CASCADE,
	FOREIGN KEY("TweetID") REFERENCES "Tweet"("TweetlD") ON DELETE CASCADE
);

CREATE TABLE "Tweet" (
	"TweetlD"	INTEGER NOT NULL,
	"UserlD"	INTEGER NOT NULL,
	"Content"	VARCHAR(200),
	PRIMARY KEY("TweetlD"),
	FOREIGN KEY("UserlD") REFERENCES "User"("UserID") ON DELETE CASCADE
);
